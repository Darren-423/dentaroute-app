...
const T = { teal: "#4A0080", tealMid: "#5C10A0", tealLight: "#f0e6f6", navy: "#0f172a", slate: "#64748b", slateLight: "#94a3b8", border: "#e2e8f0", bg: "#f8fafc", white: "#fff", green: "#16a34a", greenLight: "#f0fdf4" };
    ...
    <View style={s.container}>
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.readyBanner}>
          <Text style={{ fontSize: 18, fontWeight: "700", color: T.green }}>✓</Text>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 14, fontWeight: "600", color: T.green, marginBottom: 4 }}>Ready to submit</Text>
      ...
      <View style={s.bottom}>
        <TouchableOpacity style={[s.submitBtn, loading && { opacity: 0.6 }]} onPress={handleSubmit} disabled={loading} activeOpacity={0.85}>
          {loading ? <ActivityIndicator color="#fff" size="small" /> : <Text style={s.submitBtnText}>Submit Case →</Text>}
        </TouchableOpacity>
      </View>
    </View>
  );
...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: T.white, borderRadius: 14, padding: 16, gap: 8, borderWidth: 1, borderColor: T.border },
  cardRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  cardTitle: { flex: 1, fontSize: 15, fontWeight: "600", color: T.navy },
  edit: { fontSize: 13, fontWeight: "600", color: T.tealMid },
  ...
  statusText: { fontSize: 12, fontWeight: "600", color: T.green },
  readyBanner: { flexDirection: "row", gap: 12, backgroundColor: T.greenLight, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: "rgba(22,163,74,0.2)", alignItems: "flex-start" },
  bottom: { paddingHorizontal: 24, paddingVertical: 16, borderTopWidth: 1, borderTopColor: T.border, backgroundColor: T.white },
  submitBtn: { backgroundColor: T.teal, borderRadius: 14, paddingVertical: 15, alignItems: "center", minHeight: 52 },
  submitBtnText: { color: T.white, fontSize: 16, fontWeight: "700" },
  submittedWrap: { flex: 1, backgroundColor: T.bg, justifyContent: "center", alignItems: "center", paddingHorizontal: 28 },
  submittedTitle: { fontSize: 28, fontWeight: "700", color: T.navy, marginBottom: 12 },
  submittedDesc: { fontSize: 14, color: T.slate, textAlign: "center", lineHeight: 22, marginBottom: 28 },
  stepsBox: { width: "100%", backgroundColor: T.white, borderRadius: 16, padding: 20, marginBottom: 28, borderWidth: 1, borderColor: T.border },
  stepRow: { flexDirection: "row", alignItems: "center", gap: 14 },
  stepDot: { width: 30, height: 30, borderRadius: 15, backgroundColor: T.green, alignItems: "center", justifyContent: "center" },
  stepDotGray: { backgroundColor: T.border },
  stepDotText: { color: T.white, fontSize: 14, fontWeight: "700" },
  stepDotTextGray: { color: T.slateLight, fontSize: 13, fontWeight: "600" },
  stepTextDone: { fontSize: 14, fontWeight: "600", color: T.green },
  stepTextPending: { fontSize: 14, color: T.slate },
  stepLine: { width: 2, height: 20, backgroundColor: T.border, marginLeft: 14 },
  dashBtn: { width: "100%", backgroundColor: T.teal, borderRadius: 14, paddingVertical: 15, alignItems: "center" },
  dashBtnText: { color: T.white, fontSize: 16, fontWeight: "700" },
});
